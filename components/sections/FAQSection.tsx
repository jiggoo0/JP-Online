...
const FAQS = [
  {
    ...
    answer:
      "ทำได้จริงครับ! เราเชี่ยวชาญการปั้นโปรไฟล์ให้คนทำงานอิสระโดยเฉพาะ โดยใช้ระบบ 'Internal Audit Simulation' เพื่อสร้างตรรกะรายได้ที่ระบบสากลยอมรับ แม้คุณจะไม่มีสลิปเงินเดือนหรือใบจดทะเบียนการค้าครับ",
  },
  {
    question: "เงินในบัญชีมีไม่เยอะ หรือสเตทเม้นท์เดินไม่สวย จ้างวางยุทธศาสตร์ได้ไหม?",
    answer:
      "จ้างได้ครับ เราไม่ได้ดูแค่ยอดเงินปลายทาง แต่เราช่วยวางโครงสร้างการเดินบัญชีใหม่ (Capital Structuring) เพื่ออุดรอยโหว่ที่ทำให้คุณถูกปฏิเสธในอดีต เปลี่ยนโปรไฟล์ที่ดูไม่มีหวังให้กลับมามีความน่าเชื่อถืออีกครั้ง",
  },
  {
    question: "ทำไมต้องใช้ระบบ GDS และใบจองสถานะจริงในการยื่นวีซ่า?",
    answer:
      "เพราะสถานทูตสามารถเช็ครหัส PNR ได้จริงครับ การใช้ใบจองปลอมจะทำให้คุณเสี่ยงต่อการโดนแบนถาวร ระบบของเราจึงใช้ GDS System Injection เพื่อให้ชื่อคุณอยู่ในฐานข้อมูลสากลตลอดช่วงการพิจารณา เพื่อความปลอดภัยสูงสุด",
  },
  {
    question: "ข้อมูลของผมจะปลอดภัยและเป็นความลับแค่ไหน?",
    answer:
      "ความเป็นส่วนตัวคือหัวใจของเรา ข้อมูลลูกค้าทุกเคสจะถูกเก็บเป็นความลับสูงสุดใน 'The Vault' และจะถูกทำลายทิ้งทันทีเมื่อจบภารกิจ มั่นใจได้ว่าไม่มีการรั่วไหลแน่นอน 100% ครับ",
  },
];
          ...
          {FAQS.map((faq, index) => (
            ...
            >
              <button
                ...
                className="flex w-full flex-col items-start justify-between p-10 text-left md:flex-row md:p-14"
              >
